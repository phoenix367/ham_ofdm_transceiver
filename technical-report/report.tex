...
\input{sections/03-phy-layer}
\input{sections/04-synchronization}
\input{sections/05-adaptive-modes}
\input{sections/06-llr-calibration}
\input{sections/07-coding-extensions}
\input{sections/08-link-layer}
\input{sections/09-afc-netting}
\input{sections/10-rf-channel}
\input{sections/11-fixed-point}
\input{sections/12-validation-results}
\input{sections/12b-c-implementation}
