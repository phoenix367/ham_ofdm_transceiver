...
\S\ref{sec:cport_voice} (design in \S\ref{sec:voice_design}), whose
remaining question is a failure rate rather than a bitrate, and whose
enrolment cost would collapse from kilobytes to tens of bytes if the
vocoder's prompt path were retrained to take a global speaker code
(\S\ref{sec:voice_facodec}); a 46.875\,Hz-spacing variant for very stable channels; and
