...
Two extensions beyond the Python reference address the fixed
...
QAM16 rung throughout.  Supporting endpoints added alongside: a
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{images/sdr_setup_loopback.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{images/sdr_setup_analyzer.png}
    \caption{Instrumented bench: the analyser measures the transmitter
             (top), and its calibration output drives the receiver
             through a 40\,dB pad (bottom).}
