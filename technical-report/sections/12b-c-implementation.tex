...
What remains unverified is the other end of the link: one half-duplex
radio cannot receive its own transmission, so proving that a receiver
\emph{decodes} the signal off the air needs a second device.  The
spectrum is correct and the level is known; the decode is future work.
