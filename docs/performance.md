...
| TCP over that tunnel, 4 kB | 44.2 B/s byte-identical, 0 drops — after the tunnel stopped discarding packets and let the kernel queue them instead (8.8 B/s before, with 12 application drops on 1 kB) |
